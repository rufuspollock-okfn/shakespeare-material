...
\newcommand*{\copyrightOS}{
  ...
  \noindent This material is `open' and may be freely copied, performed and modified without \emph{any} permission from us. Of course we'd appreciate acknowledgement of our efforts so do include a link to our website when using this if you can. We'd also love to hear about what uses our work has been put to -- you can get in contact with us by email on: \emph{info@okfn.org}.
  \\[1em]

  \noindent Source material for this document together with build instructions can be found on the project website: \emph{http://www.openshakespeare.org/}. (The source is almost certainly what you want if you are looking to modify).
